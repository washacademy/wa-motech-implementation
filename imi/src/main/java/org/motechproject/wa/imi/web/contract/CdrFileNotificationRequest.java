 ...
 *
 * IVR shall invoke this wa API to notify IVR platform when the CDR files are ready for processing.
 */
public class CdrFileNotificationRequest {
    ...
    public CdrFileNotificationRequest(String fileName, FileInfo cdrSummary, FileInfo cdrDetail) {
        ...
        this.cdrSummary = cdrSummary; // Contains one-line summary info for each request from wa system
