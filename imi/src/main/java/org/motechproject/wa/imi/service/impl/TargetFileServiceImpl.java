...
public class TargetFileServiceImpl implements TargetFileService {
    ...
    private static final String GENERATE_TARGET_FILE_EVENT = "wa.obd.generate_target_file";
...
//    }
    ...
    private String targetFileName(String timestamp) {
        return String.format("OBD_wa_%s.csv", timestamp);
    }
...
//                        // See https://applab.atlassian.net/browse/wa-301
//                        //
