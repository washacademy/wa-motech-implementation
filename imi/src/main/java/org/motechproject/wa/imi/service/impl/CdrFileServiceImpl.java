...
import org.motechproject.wa.imi.exception.InternalException;
import org.motechproject.wa.imi.exception.InvalidCallRecordFileException;
import org.motechproject.wa.imi.repository.CallDetailRecordDataService;
import org.motechproject.wa.imi.repository.CallSummaryRecordDataService;
...
public class CdrFileServiceImpl implements CdrFileService {
    ...
    private static final String CDR_CSR_CLEANUP_SUBJECT = "wa.imi.cdr_csr.cleanup";
    private static final String CDR_TABLE_NAME = "motech_data_services.wa_imi_cdrs";
    private static final String DELETE_CDR_TABLE = "DELETE FROM motech_data_services.wa_imi_cdrs where creationDate < now() - INTERVAL :interval DAY";
    private static final String DELETE_CSR_TABLE = "DELETE FROM motech_data_services.wa_imi_csrs where creationDate < now() - INTERVAL :interval DAY";
    private static final String wa_IMI_KK_PROCESS_CSR = "wa.imi.kk.process_csr";
    private static final String wa_IMI_PROCESS_CHUNK = "wa.imi.process_chunk";
    private static final String CDR_PHASE_2 = "wa.imi.kk.cdr_phase_2";
    private static final String CDR_PHASE_3 = "wa.imi.kk.cdr_phase_3";
    private static final String CDR_PHASE_4 = "wa.imi.kk.cdr_phase_4";
    private static final String CDR_PHASE_5 = "wa.imi.kk.cdr_phase_5";
    ...
    private static final String CSR_TABLE_NAME = "motech_data_services.wa_imi_csrs";
    ...
    private static final String CSR_VERIFIER_CACHE_EVICT_MESSAGE = "wa.kk.cache.evict.csv_verifier";
...
//        MotechEvent motechEvent = new MotechEvent(wa_IMI_KK_PROCESS_CSR, params);
//        if (distributed) {
...
//        MotechEvent motechEvent = new MotechEvent(wa_IMI_PROCESS_CHUNK, params);
//        eventRelay.sendEventMessage(motechEvent);
//    }
...
//                        "FROM wa_imi_chunk_audit_records WHERE file = :file";
...
//            @Override
//            public String getSqlQuery() {
//                String query = "SELECT * FROM wa_imi_chunk_audit_records WHERE file = :file AND node IS NULL LIMIT 1";
//                LOGGER.debug("SQL QUERY: {}", query);
//                return query;
//            }
//
...
//
//
//    @MotechListener(subjects = { wa_IMI_PROCESS_CHUNK })
//    @Transactional
