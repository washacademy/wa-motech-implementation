...
import org.motechproject.wa.imi.web.contract.BadRequest;
...
public class ImiControllerObdBundleIT extends BasePaxIT {
    ...
    */
    @Test
    public void verifywa214() throws IOException, InterruptedException {
        getLogger().debug("testCreateFileProcessedStatusRequestWithInvalidFileProcessedStatusError()");
        HttpPost httpPost = createFileProcessedStatusHttpPost("file.csv", FileProcessedStatus.FILE_PROCESSED_SUCCESSFULLY.getValue());
    ...
    /*
    * wa_FT_193 :To check "NotifyFileProcessedStatus" API is rejected in case the file could not
    ...
    */
    ...
    /*
    * wa_FT_194 : To check "NotifyFileProcessedStatus" API is rejected in case there is an error in checksum
    */
    @Test
    ...
    * wa_FT_195 : To check "NotifyFileProcessedStatus" API is rejected in case there is an error in records check.
    */
    @Test
