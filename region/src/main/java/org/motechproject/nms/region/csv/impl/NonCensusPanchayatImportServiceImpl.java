...
@Service("nonCensusPanchayatImportService")
public class NonCensusPanchayatImportServiceImpl extends BaseLocationImportService<Panchayat>
        implements NonCensusPanchayatImportService {
    ...
    @Autowired
    public NonCensusPanchayatImportServiceImpl(PanchayatService panchayatService,
    ...
    protected void createOrUpdateInstance(Panchayat instance) {
        Panchayat existing = panchayatService.findByBlockAndVcodeAndSvid(instance.getBlock(), instance.getVcode(),
                                                                      instance.getSvid());
        ...
        if (existing != null) {
            ...
            panchayatService.update(existing);
        } else {
    ...
    protected Map<String, CellProcessor> getProcessorMapping() {
        ...
        mapping.put(PANCHAYAT_CODE, new Optional(new GetLong()));
