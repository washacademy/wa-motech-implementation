...
public final class SwcMapper {
    ...
    public static Swachchagrahi createFlw(Map<String, Object> record, Map<String, Object> location)
    ...
    public static Swachchagrahi createRchFlw(Map<String, Object> record, Map<String, Object> location)
            throws InvalidLocationException {
