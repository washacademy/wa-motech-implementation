 ...
 */
@Entity(tableName = "wa_rch_audit")
public class RchImportAudit {
    /**
     * importDate is used in historic data.After fixing the issue wa-360: Introduce retrial of data import from MCTS service for 7 days,
